...
SRC = ft_putstr_color.c ft_atoi.c ft_puterr.c ft_itoa.c ft_bzero.c ft_countwords.c ft_isalnum.c ft_isalpha.c \
ft_isascii.c ft_isdigit.c ft_isescaped.c ft_isprint.c  ft_memalloc.c \
...
ft_putendl_fd.c ft_putnbr.c ft_putnbr_fd.c ft_putbytes.c ft_putbyte.c \
...
ft_strjoin.c ft_strlen.c  ft_strlcat.c ft_strmap.c ft_strmapi.c ft_strncat.c \
